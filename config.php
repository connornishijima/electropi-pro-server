						...
						<tr class="settingRow">
							<td class="settingLeft">
								...
								<div class="section group">
                                                                        <div class="col span1conf2">
										<div class="settingInlineNameWrap">
											<input type="text" class="settingText" name="hueTTime" value="<?php echo $sets['SETTINGS']['hueTTime'];?>"></input><div class="settingInlineName">TRANSITION TIME</div>
										</div>
                                                                        </div>
                                                                        <div class="col span1conf2">
										<div class="settingInlineNameWrap">
							...
							<td>
								...
								<div class="section group" style="margin-bottom: 10px;">
                                                                        <div class="colAlt span1cred">
                                                                                <table style="width:100%;height:100%;">
                                                                                        <tr>
                                                                                                <td class="creditLeft">SHIPPING AND INVENTORY</td>
                                                                                        </tr>
                                                                                </table>
                                                                        </div>
                                                                        <div class="colAlt span1cred">
                                                                                <table style="width:100%;height:100%;">
                                                                                        <tr>
                                                                                                <td class="creditRight">ANDREW NEAL</td>
                                                                                        </tr>
                                                                                </table>
                                                                        </div>
                                                                </div>
